	...
	return (
		...
		{init && (
			<Paper elevation={9} sx={styles.productContainer}>
				<Typography variant="h3" align="center" gutterBottom>{product.name}</Typography>
				<Divider />
				<Box
				component="img"
				...
				/>
				<Box component="div" sx={styles.split}>
				...
				<Box component="div" sx={styles.split}>
					...
					<Paper id="modal-delete" elevation={9} sx={styles.modalStyle}>
						...
						<Box component="div" sx={styles.btnGroup}>
							<Button onClick={confirmDelete} fullWidth>Confirm</Button>
